...
class _DialogoChecklistState extends State<DialogoChecklist> {
  ...
  Future<void> _guardarChecklist() async {
    ...
    bool guardado = await DatabaseHelper()
        .updateCheckListCarguio(widget.operacionId, datosAGuardar);
  ...
  Widget build(BuildContext context) {
    ...
    // Diálogo responsivo: en móvil ocupa casi todo el ancho
    final dialogWidth = isSmallScreen 
        ? screenWidth * 0.95  // En móvil: 95% del ancho
        : screenWidth * 0.8;  // En PC: 80% del ancho
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      isSmallScreen ? 'Checklist' : 'Checklist de Operación',
                      style: TextStyle(
                        color: Colors.white,
            ...
            if (checklistPorCategoria.isEmpty)
              ...
              Expanded(
                child: Column(
                  children: [
                    // Botones de acción rápida y control de expansión (responsive)
                        ...
                        child: isSmallScreen
                            ? Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  // Fila 2: Todos Sí, Todos No, Limpiar
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                    children: [
                                      _buildAccionRapida(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    // Barra de progreso (ocultar en pantallas muy pequeñas)
                    if (!isSmallScreen)
                      Container(
                        width: 80,
                        height: 4,
