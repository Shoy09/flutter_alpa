...
class _DialogoHorometroState extends State<DialogoHorometro> {
  ...
  Future<void> _cargarHorometros() async {
    setState(() {
      // Obtener datos de los 3 horómetros
      var horometroPrincipal = widget.horometrosData['horometro_principal'] ?? {};
      var electrico = widget.horometrosData['electrico'] ?? {};
      var diesel = widget.horometrosData['diesel'] ?? {};

      horometros = [
        {
          'id': 1,
          'nombre': 'Horómetro Principal',
          'inicial': horometroPrincipal['inicio'] ?? 0,
          'final': horometroPrincipal['final'] ?? 0,
          'EstaOP': horometroPrincipal['op'] == true ? 1 : 0,
          'EstaINOP': horometroPrincipal['inop'] == true ? 1 : 0,
        },
        {
          'id': 2,
          'nombre': 'Eléctrico',
          'inicial': electrico['inicio'] ?? 0,
          'final': electrico['final'] ?? 0,
          'EstaOP': electrico['op'] == true ? 1 : 0,
          'EstaINOP': electrico['inop'] == true ? 1 : 0,
        },
        {
          'id': 3,
          'nombre': 'Diesel',
  ...
  Future<void> _guardarHorometros() async {
    ...
    // Construir el mapa de horómetros para guardar (3 horómetros)
    ...
    bool guardado = await DatabaseHelper().updateHorometrosAnfochanger(
      widget.operacionId,
      horometrosToSave,
    );
  ...
  Widget _buildTable() {
    return Container(
      ...
      child: Table(
        ...
        columnWidths: const {
          0: FixedColumnWidth(180), // Para nombres
          1: FixedColumnWidth(90),  // Inicial
          2: FixedColumnWidth(90),  // Final
          3: FixedColumnWidth(50),  // OP
          4: FixedColumnWidth(50),  // INOP
        },
        children: [
          // Header
          TableRow(
