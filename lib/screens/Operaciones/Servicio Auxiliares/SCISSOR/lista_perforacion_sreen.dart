...
class TaladroSCISSORScreen extends StatefulWidget {
  ...
  const TaladroSCISSORScreen({Key? key, this.rolUsuario, this.dniUsuario}) : super(key: key);
...
Future<void> _cargarEstadosOperacion() async {
  ...
  List<Map<String, dynamic>> estados =
      await DatabaseHelper().getEstadosByOperacionIdScissor(operacionId!);
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    int filasAfectadas =
                        await DatabaseHelper().eliminarOperacionTalScissorFisico(operacionId!);
...
Future<void> _crearRegistroEstado(Map<String, dynamic> data, String estado) async {
  try {
    ...
    Map<String, dynamic>? nuevoEstado = await DatabaseHelper().createEstadoScissor(
      operacionActual!['id'],
      estado,
      data['codigo']!,
      data['hora_inicio']!,
...
Future<List<Map<String, dynamic>>> _getOperaciones() async {
  if (operacionActual == null) return [];
  return await DatabaseHelper().getEstadosByOperacionIdScissor(operacionActual!['id']);
}
...
Future<void> _handleNuevaOperacion(Map<String, dynamic> data) async {
  ...
  List<Map<String, dynamic>> horometros =
      await dbHelper.getHorometrosPorOperacion('scissor');
  ...
  List<Map<String, dynamic>> checklistItems =
      await DatabaseHelper().getCheckListByProceso('SCISSOR');
      ...
      return DialogoConfirmarCierreRegistros(
        ...
        onConfirmar: () async {
          ...
          try {
            ...
            await DatabaseHelper().cerrarOperacionScissor(operacionActual!['id']);
