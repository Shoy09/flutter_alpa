...
import 'package:i_miner/screens/Operaciones/Servicio%20Auxiliares/Scalamin/widgets/dialogo_no_operativo_formulario_perforacion.dart' show DialogoFormularioNoOpePerforacion;
...
class TaladroScalaminScreen extends StatefulWidget {
  ...
  const TaladroScalaminScreen({Key? key, this.rolUsuario, this.dniUsuario}) : super(key: key);
...
Future<void> _cargarEstadosOperacion() async {
  ...
  List<Map<String, dynamic>> estados =
      await DatabaseHelper().getEstadosByOperacionIdScalamin(operacionId!);
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    int filasAfectadas =
                        await DatabaseHelper().eliminarOperacionTalScalaminFisico(operacionId!);
...
Future<List<Map<String, dynamic>>> _getOperaciones() async {
  if (operacionActual == null) return [];
  return await DatabaseHelper().getEstadosByOperacionIdScalamin(operacionActual!['id']);
}
    ...
    builder: (BuildContext context) {
      return DialogoFormularioRompebanco(
        ...
        onGuardar: (datosActualizados) async {
          bool guardado = await DatabaseHelper().updateOperacionByEstadoIdScalamin(
            operacionActual!['id'],
            estadoId,
            datosActualizados,
          );
...
Future<void> _handleNuevaOperacion(Map<String, dynamic> data) async {
  ...
  List<Map<String, dynamic>> horometros =
      await dbHelper.getHorometrosPorOperacion('scalamin');
  ...
  List<Map<String, dynamic>> checklistItems =
      await DatabaseHelper().getCheckListByProceso('SCALAMIN');
...
Future<void> _editarOperacionOperativo(Map<String, dynamic> operacion) async {
  Map<String, dynamic> datosRompebanco = await DatabaseHelper()
      .getOperacionByEstadoIdScalamin(operacionActual!['id'], operacion['id']);
      ...
      return DialogoConfirmarCierreRegistros(
        ...
        onConfirmar: () async {
          ...
          try {
            ...
            await DatabaseHelper().cerrarOperacionScalamin(operacionActual!['id']);
