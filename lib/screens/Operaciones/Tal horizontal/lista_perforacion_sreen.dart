...
void _mostrarDialogoEstado(String estado) async {
  ...
  // ✅ AGREGAR ESTA FUNCIÓN AQUÍ (igual que en el primer código)
  ...
  // ✅ ORDENAR USANDO LA FUNCIÓN CON AJUSTE DE TURNO
  ...
  if (todosLosEstados.isNotEmpty) {
    ...
    print("✅ ÚLTIMA HORA (con ajuste de turno): $ultimaHora");
  ...
  final result = await showRegistroOperacionDialog(
    ...
    turno: turnoActual,  // ✅ Usar turnoActual
...
void _handleHorometro() async {
  ...
  String estado = operacionActual!['estado'] ?? 'OPERATIVO';
  String nEquipo = operacionActual!['n_equipo']?.toString() ?? '';
      ...
      return DialogoConfirmarCierreRegistros(
        ...
        onConfirmar: () async {
          ...
          try {
            ...
            _mostrarSnackBar(
              'Registro cerrado exitosamente. Se agregó estado DEMORA',
              Colors.green,
            );
