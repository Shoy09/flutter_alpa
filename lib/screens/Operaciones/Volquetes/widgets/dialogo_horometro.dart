...
class DialogoHorometroVolquetes extends StatefulWidget {
  final int operacionId;
  final String estado;
  final Map<String, dynamic> horometrosData;
  final Color primaryColor;

  const DialogoHorometroVolquetes({
    Key? key,
  ...
  @override
  State<DialogoHorometroVolquetes> createState() => _DialogoHorometroState();
}

class _DialogoHorometroState extends State<DialogoHorometroVolquetes> {
  ...
  Future<void> _cargarHorometros() async {
    setState(() {
      ...
      var kilometraje = widget.horometrosData['kilometraje'] ?? {};
      var combustible = widget.horometrosData['combustible'] ?? {};
      var ralenty = widget.horometrosData['Ralenty'] ?? {};
      var litraje = widget.horometrosData['Litraje'] ?? {};
      ...
      horometros = [
        ...
        },
        {
          'id': 2,
          'nombre': 'Kilometraje',
          'inicial': kilometraje['inicio'] ?? 0,
          'final': kilometraje['final'] ?? 0,
          'EstaOP': kilometraje['op'] == true ? 1 : 0,
          'EstaINOP': kilometraje['inop'] == true ? 1 : 0,
        },
        {
          'id': 3,
          'nombre': 'Combustible',
          'inicial': combustible['inicio'] ?? 0,
          'final': combustible['final'] ?? 0,
          'EstaOP': combustible['op'] == true ? 1 : 0,
          'EstaINOP': combustible['inop'] == true ? 1 : 0,
        },
        {
          'id': 4,
          'nombre': 'Ralenty',
          'inicial': ralenty['inicio'] ?? 0,
          'final': ralenty['final'] ?? 0,
          'EstaOP': ralenty['op'] == true ? 1 : 0,
          'EstaINOP': ralenty['inop'] == true ? 1 : 0,
        },
        {
          'id': 5,
          'nombre': 'Litraje',
          'inicial': litraje['inicio'] ?? 0,
          'final': litraje['final'] ?? 0,
          'EstaOP': litraje['op'] == true ? 1 : 0,
          'EstaINOP': litraje['inop'] == true ? 1 : 0,
        }
      ];
  ...
  Future<void> _guardarHorometros() async {
    ...
    bool guardado = await DatabaseHelper().updateHorometrosVolquetes(
      widget.operacionId,
      horometrosToSave,
    );
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            isSmallScreen ? 'Horometros y Kilometraje' : 'Horometros y Kilometraje',
                            style: TextStyle(
                              color: Colors.white,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (isEditable)
                      ElevatedButton(
                        onPressed: _isSaving ? null : _guardarHorometros,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              _isSaving ? 'Guardando...' : (_hayErrores() ? 'Corregir' : 'Guardar'),
                              style: TextStyle(
                                fontSize: isSmallScreen ? 12 : 13,
                                fontWeight: FontWeight.w600,
                              ),
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    Icon(
                      index == 0 ? Icons.speed : Icons.timer,
                      size: 20,
                      color: widget.primaryColor,
                    ),
                    const SizedBox(width: 8),
  ...
  // Vista de tabla para desktop/tablets
  Widget _buildTable() {
    return Container(
      decoration: BoxDecoration(
