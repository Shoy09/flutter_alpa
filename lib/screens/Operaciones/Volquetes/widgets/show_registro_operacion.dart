...
import 'package:i_miner/screens/Operaciones/Volquetes/widgets/registro_operacion_dialog.dart';

Future<Map<String, dynamic>?> showRegistroOperacionDialogVolquetes({
  ...
  return showDialog<Map<String, dynamic>>(
    ...
    builder: (BuildContext context) {
      return RegistroOperacionDialogVolquetes(
