...
class _DialogoHorometroState extends State<DialogoHorometro> {
  ...
  Future<void> _cargarHorometros() async {
    setState(() {
      ...
      // AHORA CON 4 HORÓMETROS: Diesel, Eléctrico, Percusión, Empernador
      horometros = [
        {
          'id': 1,
          'nombre': 'Diesel',
  ...
  Future<void> _guardarHorometros() async {
    ...
    // Construir el mapa de horómetros para guardar (AHORA CON 4)
    ...
    bool guardado = await DatabaseHelper().updateHorometrosEmpernador(
      widget.operacionId,
      horometrosToSave,
    );
